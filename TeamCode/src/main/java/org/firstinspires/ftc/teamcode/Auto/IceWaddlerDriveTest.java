...
@Autonomous(name = "IWDriveTester", group = "org.firstinspires.ftc.teamcode.Auto")

public class IceWaddlerDriveTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        iceWaddler.runByPos(
                iceWaddler.odo.getPosition(),
                new Pose2D(DistanceUnit.METER,1, 0.5, AngleUnit.DEGREES, 90),
                true
        );
