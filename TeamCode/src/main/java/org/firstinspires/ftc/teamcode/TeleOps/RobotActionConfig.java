...
public class RobotActionConfig {
    ...
    public static double intake_Wrist_Idle              = 0.20;  // Final
    public static double intake_Wrist_Pick              = 0.645; // Final
    public static double intake_Wrist_Transfer          = 0.12;  // Final
