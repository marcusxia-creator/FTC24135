    ...
    public void loop () {
        ...
        switch (currentState) {
            ...
            case DONE:
                ...
                telemetry.addData("Camera Exposure", camera.getExposureControl().getExposure(TimeUnit.MILLISECONDS));
                telemetry.addData("Camera Gain", camera.getGainControl().getGain());
                break;
        }
